  ...
  def read(self, locs, n_bytes):
    ...
    for f_name, offset in locs:
      if f_name not in self._open_files:
        self._open_files[f_name] = open("chamber_of_secrets/postings_gcp/" + f_name, 'rb')
...
class InvertedIndex:  
  def __init__(self, docs={}):
    ...
    """
    #normalize factor for docs tfidf
    self.nf_docs = {}
    # stores the titles of the documents
    self.title = {}
    # stores doc length per doc
    self.dl = {}
